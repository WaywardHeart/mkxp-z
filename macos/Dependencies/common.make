...
$(DOWNLOADS)/ogg/autogen.sh:
	$(CLONE) $(GITHUB)/JaidenAlemni/ogg $(DOWNLOADS)/ogg -b mkxp-z-1.3.5
...
$(DOWNLOADS)/physfs/CMakeLists.txt:
	$(CLONE) $(GITHUB)/JaidenAlemni/physfs -b release-3.2.0 $(DOWNLOADS)/physfs
...
$(DOWNLOADS)/sdl2_image/CMakeLists.txt:
	$(CLONE) $(GITHUB)/JaidenAlemni/SDL_image $(DOWNLOADS)/sdl2_image -b mkxp-z-2.6.3
...
$(DOWNLOADS)/sdl2_ttf/autogen.sh:
	$(CLONE) $(GITHUB)/JaidenAlemni/SDL_ttf $(DOWNLOADS)/sdl2_ttf -b mkxp-z
...
$(DOWNLOADS)/freetype/autogen.sh:
	$(CLONE) $(GITHUB)/JaidenAlemni/Freetype2 $(DOWNLOADS)/freetype
...
$(DOWNLOADS)/openal/CMakeLists.txt:
	$(CLONE) $(GITHUB)/JaidenAlemni/openal-soft $(DOWNLOADS)/openal -b mkxp-z-1.22.2
